import { VariantIconClassName, VariantIconClassNames, VariantMessageAreaClassNames, VariantType } from '@/systems/defines'
import { MJComponent, ref, Reference } from '@mj/jsx'

export class ShotMessage extends MJComponent {
