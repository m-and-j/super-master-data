...
interface Props extends MJ.CEProps<OutputSourceCode> {
 ...
 * 基本ソースコード出力設定
 */
export class OutputSourceCode extends MJCustomElement<Props>()(HTMLFieldSetElement) {
  connectedCallback() {
    ...
    return (
      <>
        <div class="mb-2 flex items-center gap-2">
          ...
          <div class="flex-auto">
            <InputText placeholder="出力先ファイル" value={outputProjectStandard.path} onchange={(e) => this.changePath(e)} />
          </div>
        </div>
        <div class="mb-2 flex items-center gap-2">
